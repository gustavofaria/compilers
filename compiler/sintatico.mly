 ...
 declaracao: ids = separated_nonempty_list(VIRG, ID) DPTOS t = tipo {
 ...
 comando_entrada:
 ENTRADA xs=separated_nonempty_list(VIRG, variavel) PTV {
 CmdEntrada xs
 }

 comando_saida:
 SAIDA xs=separated_nonempty_list(VIRG, variavel) PTV {
 CmdSaida xs
 }
